...
// Links
- (void)sourceLink {
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://github.com/samoht9277/Public-Tweaks/Sana"] options:@{} completionHandler:nil];
...
- (void)showAlert {
    ...
    message:@"Sana does not fully support notched devices yet.\n \n Feel free to try it if you want.\n \n (This will only show once.)"
